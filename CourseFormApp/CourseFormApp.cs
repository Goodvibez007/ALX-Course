    ...
    public partial class FormApp : Form
    {
        ...
        private void DoNotClickButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MessageBox.Show("You fucking rebel!!!");
            }
            ...
            /*throw new OurOwnException("That's a good one :P");
            MessageBox.Show("You fucking rebel!!!");*/
        }
        ...
        private void CalculateButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                var result = PerformOperation(Convert.ToDouble(XNumberTextBox.Text), Convert.ToDouble(YNumberTextBox.Text));
